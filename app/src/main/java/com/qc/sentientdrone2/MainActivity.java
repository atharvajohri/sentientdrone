...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpen(View v) throws IOException, InterruptedException {
        ...
        if(mPhysicaloid.open()) {
            ...
            Log.i("MAIN", "Starting WS server");
            SDServer sdServer = new SDServer(8887);
            sdServer.startServer();
        } else {
